...
export default function TopTrackSpotify() {
  ...
  return (
    <div>
      ...
      I love listening to music a lot, Click to the number to listen to the preview, <a className="text-rose hover-underline-animation" href="https://open.spotify.com/user/31ja26tecrsyeh6juobkidxolszq" target="_blank" rel="noopener noreferrer">my playlists.</a>🎐 
        </p>
      </div>
