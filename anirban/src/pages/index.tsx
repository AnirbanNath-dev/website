    ...
    <div className="space-y-10">
      <div className="border-b-[1px] pb-5 border-muted">
        <h1 className="text-3xl font-bold tracking-wide md:text-4xl text-text sm:leading-10 md:leading-14">
          Hi, I am{" "}
          <Link href="/about">
            <a className="hover-underline-animation text-rose">Anirban Nath{""}</a>
          </Link>
          <span className="ml-4 text-xl text-subtle">
            aka{" "}
            <span className="text-rose hover-underline-animation">
              <a href="" target="_blank" rel="noopener noreferrer">`Ani`</a> 
            </span>
        ...
        <h2 className="mt-3 md:text-lg text-subtle">
          ...
          <b> I&apos;m a 17 y/o self-taught developer who likes to code,  <a className="text-gold hover-underline-animation" href="mailto:anirbaniitian@gmail.com" target="_blank" rel="noopener noreferrer"> reach out to me. 📧 </a>  </b> 
        </h2>
      </div>
      <p className="px-5 py-3 border-l-8 border-gold text-gl bg-surface">
      <b>🔮 Looking for my projects.. </b><a className="hover-underline-animation" href="https://github.com/AnirbanNath-dev" target="_blank" rel="noreferrer"> Well, <b className="text-gold"> Github</b> is the place of all of my codes. </a> 
      </p>
